...
model.load_state_dict(torch.load("/home/psboys/private/automous/PyTorch-Deformable-Convolution-v2/example_model_state_dict.pth"))
...
with torch.no_grad():
    while True:
        image = cv2.imread("/home/psboys/private/automous/PyTorch-Deformable-Convolution-v2/example.png", flags=cv2.IMREAD_GRAYSCALE)
